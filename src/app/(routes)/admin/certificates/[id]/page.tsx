  ...
  return (
    <>
      <div className="flex items-center gap-4 mb-8">
        <Link href="/admin/certificates" className="btn-outline text-sm py-2 px-4 flex items-center gap-2">
        ...
        >
          <GradientHeading className="pb-2">Edit Certificate</GradientHeading>
        </motion.div>
      </div>
