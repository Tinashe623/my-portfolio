...
export default function Footer() {
  const WHATSAPP = (import.meta.env.VITE_WHATSAPP_PHONE || import.meta.env.VITE_CONTACT_PHONE || '').replace(/[^\d]/g, '')
  ...
  const CV_URL = rawCV ? (rawCV.startsWith('http') || rawCV.startsWith('/') ? rawCV : `/${rawCV}`) : ''
